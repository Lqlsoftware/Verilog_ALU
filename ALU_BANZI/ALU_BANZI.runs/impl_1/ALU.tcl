...
set rc [catch {
  ...
  set_property ip_repo_paths {{c:/Users/LqlSoft Computer/Xilinx/Lql/ALU_BANZI/ALU_BANZI.cache/ip}} [current_project]
  set_property ip_output_repo {{c:/Users/LqlSoft Computer/Xilinx/Lql/ALU_BANZI/ALU_BANZI.cache/ip}} [current_project]
  add_files -quiet {{C:/Users/LqlSoft Computer/Xilinx/Lql/ALU_BANZI/ALU_BANZI.runs/synth_1/ALU.dcp}}
  link_design -top ALU -part xc7a35tcsg324-1
